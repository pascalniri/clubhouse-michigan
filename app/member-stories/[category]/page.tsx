    ...
    <main className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <section className="pt-40 pb-20 px-4 sm:px-6 lg:px-8 bg-brand-blue">
        <div className="max-w-7xl mx-auto">
          <Link href="/member-stories" className="text-sm font-bold text-white/70 hover:text-white transition-colors mb-8 inline-block uppercase tracking-widest">
        ...
        <div className="max-w-4xl mx-auto">
          {filteredStories.length > 0 ? (
              ...
              {filteredStories.map((story, idx) => (
                ...
                >
                  ...
                  <div className="max-w-3xl">
                    <h2 className="text-lg md:text-xl font-bold text-brand-blue mb-8">
                      {story.title}
                    </h2>
            ...
            <div className="text-center py-20">
              <p className="text-xl text-[#4A4A68] font-medium">More stories coming soon to this category.</p>
