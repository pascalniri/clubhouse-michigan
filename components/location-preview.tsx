                    ...
                    <div className="lg:w-1/2 text-white">
                        ...
                        >
                            <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                                Serving Communities Across <span className="text-[#9f2943]">Michigan</span>
                            </h2>
                            <p className="text-gray-300 text-lg mb-8 max-w-xl leading-relaxed">
                                With over <span className="text-white font-bold">40 direct service Clubhouses</span> covering more than <span className="text-white font-bold">30 counties</span>,
                                support is never far away. Find a community near you and start your journey today.
                            </p>
                    ...
                    <div className="lg:w-1/2 w-full relative h-[400px]">
                        ...
                        >
                            ...
                            <div className="relative z-10 h-full flex items-center justify-center flex-col text-center">
                                <MapPin size={48} className="text-[#9f2943] mb-4" />
                                <h3 className="text-2xl font-bold text-white mb-2">40+ Locations</h3>
                                <p className="text-gray-400">Connecting Michigan</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
