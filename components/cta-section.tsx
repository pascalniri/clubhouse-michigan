      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#9f2943] rounded-[2.5rem] p-8 md:p-16 relative overflow-hidden text-center shadow-2xl">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            >
              Your support empowers individuals living with mental illness to
              reach their full potential. Whether through donation, advocacy, or
              partnership, you are building a stronger community.
            </motion.p>
              ...
              {[
                ...
                return (
                  ...
                  >
                    <Icon
                      size={32}
                      className={item.primary ? "fill-[#9f2943]" : ""}
                    />
